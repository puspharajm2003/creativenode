...
import f1 from "@/assets/poster-fashion-1.jpg";
import f2 from "@/assets/poster-fashion-2.jpg";
import f3 from "@/assets/poster-fashion-3.jpg";

const items = [
  { src: f1, label: "Sale Poster", tag: "Mega Sale" },
  { src: f2, label: "Festival Offer", tag: "Diwali" },
  { src: f3, label: "Branding Poster", tag: "New Collection" },
];

export const Slide06Fashion = () => (
  <SlideLayout pageNumber={6}>
    <div className="absolute inset-0 px-32 pt-28">
      <div className="flex items-end justify-between mb-12">
        <div>
          <SlideEyebrow>Sample Works · 02</SlideEyebrow>
          <h2 className="font-display font-bold text-[88px] leading-none">
            Fashion <span className="gold-text italic">& Offer Posters</span>
          </h2>
        </div>
        <span className="font-serif-elegant italic text-cream/50 text-[24px]">Recent campaigns</span>
      </div>
